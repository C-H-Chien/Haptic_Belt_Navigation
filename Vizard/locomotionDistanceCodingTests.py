...
###########################################################################################################
# Define variables
port = 'COM6'					#Port for communication 
...
def chooseSignal(motorIntensities):
	...
	slope = (maxP-minP) / (maxD - minD)
	intercept = minD*slope - minP
	
	if distToDest>maxD:
		CLICK_ON_PERIOD = maxP
	elif distToDest<minD:
		CLICK_ON_PERIOD = minP
	else:
		CLICK_ON_PERIOD = slope * distToDest - intercept
