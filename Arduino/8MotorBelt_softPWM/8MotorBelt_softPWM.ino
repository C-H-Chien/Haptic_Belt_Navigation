...
SOFTPWM_DEFINE_OBJECT_WITH_PWM_LEVELS(13, 256); // arg1 is number of channels. Needs to go to at least 13 since we using pin 12. Not sure why it works this way. arg2 is PWM lvls

int const nMotor = 8;
int motorPowerList[nMotor];
//int motorPin[nMotor] = {12,11,10,9,8,7,6,5}; // for 8 motor belt only
//int motorPin[nMotor] = {10,9,8,7,6,5,12,11}; // for 8 motor belt only, rotated 90 deg CW
int motorPin[nMotor] = {6,5,12,11,10,9,8,7}; // for 8 motor belt only
int motorIdx;
