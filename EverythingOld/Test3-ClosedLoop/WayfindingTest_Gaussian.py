...
polePosition1 = [3, 1, 3]
polePosition2 = [-3, 1, 2] # x,y,z where y is vertical axis
polePosition3 = [3,1,-2]
...
def masterLoop(num):
	global time, polePosition1, motionModel, ser, record, start, pystart, recordPos, recordOrient, finished
...
#	emergencyWallsNormal.popWalls(curPos)
	...
	if distToDest < 0.5 and finished == 0:
		...
		for num in directionsToSend:
			ser.write(struct.pack('>B', num))
		numpy.save('positions_1C.npy', recordPos)
		numpy.save('orientations_1C.npy', recordOrient)
