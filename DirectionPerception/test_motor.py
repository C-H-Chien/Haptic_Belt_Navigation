...
def runDirectionTest(port, numMotors, subID):
   ...
   angles = [(0.0, 0), (22.5, 0), (45.0, 0), (67.5, 0), (90.0, 0), (112.5, 0),(135.0, 0),(157.5, 0), (180.0, 0), (202.5, 0), (225.0, 0), (247.5, 0), (270.0, 0),  (292.5, 0),  (315.0, 0), (337.5, 0)]
...
def check_repetitions(arr, required_repetitions=1):
